...
int main(void)
{
    ...
    while (!sair)
    {
        ...
        if(!preencher)
        {
             /**< Desenha o elemento geométrico respectivo do botão */
            Des_Quadrado( desenha_quadrado);
            Des_Circulo( desenha_circulo);
            Des_Retangulo( desenha_retangulo);
            Des_Elipse( desenha_elipse);
            Des_Triangulo ( desenha_triangulo);
        }
        else if(preencher)
        {
            /**< Desenha o elemento geométrico preenchido respectivo do botão */
            Des_Quadrado_preenchido( desenha_quadrado);
            Des_Circulo_preenchido( desenha_circulo);
            Des_Retangulo_preenchido( desenha_retangulo);
            Des_Elipse_preenchido( desenha_elipse);
            Des_Triangulo_preenchido ( desenha_triangulo);
        }
